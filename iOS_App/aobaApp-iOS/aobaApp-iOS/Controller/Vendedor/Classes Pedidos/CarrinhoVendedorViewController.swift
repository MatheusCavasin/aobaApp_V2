        ...
        if maisDeTresItems {
            if indexPath.row < 3 {
                ...
                if ModelVendedor.instance.dictListaCarrinho.isEmpty {
                    ...
                    cell.config(valor: (ModelVendedor.instance.dictListaCarrinho["valorTotal"] as? Float ?? 0.00) - (ModelVendedor.instance.dictListaCarrinho["valorFrete"] as? Float ?? 0.00))
                }
                return cell
                ...
                if ModelVendedor.instance.dictListaCarrinho.isEmpty {
                    ...
                    cell.config(valor: ModelVendedor.instance.dictListaCarrinho["valorFrete"] as! Float)
                }
                return cell
                ...
                if ModelVendedor.instance.dictListaCarrinho.isEmpty {
                    ...
                    cell.config(valorTotal: ModelVendedor.instance.dictListaCarrinho["valorTotal"] as! Float)
                }
                return cell
            }  else {
            ...
            if indexPath.row < self.itens.count {
                ...
                if ModelVendedor.instance.dictListaCarrinho.isEmpty {
                    ...
                    cell.config(valorTotal:(ModelVendedor.instance.dictListaCarrinho["valorTotal"] as? Float ?? 0.00) + (ModelVendedor.instance.dictListaCarrinho["valorFrete"] as? Float ?? 0.00))
                }

...
//  aobaApp-iOS
//
//  Created by M Cavasin on 28/10/20.
//  Copyright © 2020 M Cavasin. All rights reserved.
//

import UIKit

class PedidosVendedorViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func setupPedidoEmAndamento() {
        viewEmAndamento.setDefaultColor(color: #colorLiteral(red: 1, green: 0.5716887116, blue: 0.1306569278, alpha: 1))
...
extension PedidosVendedorViewController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.config(text: "Avalie seus pedidos passados", color: #colorLiteral(red: 1, green: 0.5716887116, blue: 0.1306569278, alpha: 1))
            return cell
